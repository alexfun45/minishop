        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <img
              src={imagePreview}
              alt="Preview"
              className="w-full sm:w-80 h-auto max-h-80 object-contain rounded-xl border border-gray-200 shadow-md bg-gray-50 p-1"
            />
            <button
              type="button"
              onClick={handleRemoveImage}
              className="absolute -top-3 -right-3 bg-red-500 text-white rounded-full p-1.5 hover:bg-red-600 focus:outline-none shadow-md transition-all hover:scale-110"
            >
